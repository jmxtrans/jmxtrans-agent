...
public class PlaceholderEnabledJsonNodeFactoryTest {
    ...
    public void testWithPlaceholders() throws Exception {
        ...
        try {
            String configurationUrl = "org/jmxexporter/util/json/jmxexporter-placeholder-test.json";
            ...
            assertThat(outputWriterNode.path("@class").asText(), is("org.jmxexporter.output.GraphiteWriter"));
